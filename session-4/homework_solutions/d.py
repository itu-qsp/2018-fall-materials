...
print(count_word_in_text('woman'))
print(count_word_in_text('drawing'))
print(count_word_in_text('was'))

# Alternately we can pass the text we want to analyse to the function
def count_word_in_text(word, text_to_analyse):
    counter = 0 
...
print(count_word_in_text('woman', text))
print(count_word_in_text('drawing', text))
print(count_word_in_text('was', text))